...
//	$username=$_POST['username'] ;
	...
	$insert=$conn->prepare("INSERT INTO shafaye1_weblog_ketab_sara.blogs SET title=? , caption=? , writer=? , readtime=? , image=? , tags=? , time=? , date=?");	#hamegi = ?  baraye amnite bishtar dar ravesh PDO conn
...
<div class="add-edit-blog">
	...
	<fieldset>
		<legend class="form-legend"> افزودن مقاله جدید </legend>
		...
		<input type="text" name="title" class="form-control" id="title" placeholder="موضوع مقاله" >
...
<!--		<div id="msg_writer"> لطفا نام نویسنده را وارد کنید </div>-->
		...
		<input type="number" name="readtime" class="form-control" id="readtime" placeholder="زمان تقریبی مطالعه">
		<div id="msg_readtime"> لطفا زمان تقریبی مطالعه را وارد کنید </div>
		
		<input type="text" name="image" class="form-control" id="image" placeholder="لینک عکس را از صفحه آپلود فایل کپی کنید">
		<div id="msg_image"> لطفا لینک عکس را وارد کنید </div>
		
		<input type="text" name="tags" class="form-control" id="tags" placeholder="تگ‌ها">
